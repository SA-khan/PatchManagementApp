<%@ Page Title="Portal - Delete User Role" Language="C#" MasterPageFile="~/MasterPages/SimpleLogin.Master" AutoEventWireup="true" CodeBehind="DeleteUserRole.aspx.cs" Inherits="HelloWorld.ProtectedPages.DeleteUserRole" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <asp:Panel ID="Panel1" runat="server">
        <asp:Table ID="Table1" runat="server" Width="100%" BackColor="Menu" BorderStyle="Solid" BorderColor="DarkGray" BorderWidth="2px" HorizontalAlign="Center" CellSpacing="5" CellPadding="5" style="margin:5px;padding:5px;">
            <asp:TableHeaderRow Height="40px">
                <asp:TableHeaderCell ColumnSpan="3" HorizontalAlign="Left" style="margin:5px;padding:5px;">
                    <asp:Label ID="Label1" runat="server" Text="Delete A User Role.." Font-Italic="true" ForeColor="Black" Font-Names="Arial" Font-Size="Large"></asp:Label>
                    ...
                    <br />
                    <br />
                    <asp:Label ID="lblSubmission" runat="server" Text="User Role is successfully deleted." Font-Italic="true" ForeColor="Navy" Font-Names="Arial" Font-Size="Medium" Visible="false"></asp:Label>
                </asp:TableHeaderCell>
            </asp:TableHeaderRow>
        ...
        DataValueField="ROLE_ID" AutoPostBack="false" ViewStateMode="Enabled" 
        ...
        SelectCommand="SELECT [ROLE_ID],[ROLE_Title] FROM [ROLES]"></asp:SqlDataSource>
                ...
                <asp:TableCell>
                    <asp:RequiredFieldValidator ID="ReqUserRole" runat="server" InitialValue="Select.." ControlToValidate="dropUserRole"  ErrorMessage="Please Select User Role" Text="(Required)" ForeColor="Red" Font-Bold="true"></asp:RequiredFieldValidator>
                </asp:TableCell>
            </asp:TableRow>
