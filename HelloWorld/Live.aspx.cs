...
namespace HelloWorld
{
    public partial class Live : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                log.DetailLog("AppOverview.aspx", "Page_Load", STATE.INITIALIZED, "Method: Page_Load in Class: AppOverview.aspx has Initialized.");
                ...
                log.DetailLog("AppOverview.aspx", "Page_Load", STATE.COMPLETED, "Method: Page_Load Inn Class: AppOverview.aspx Has Completed Its Execution Successfully.");
            }
            catch (Exception ex)
            {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                log.DetailLog("AppOverview.aspx", "btnSearch_Click", STATE.INITIALIZED, "Method: btnSearch_Click in Class: AppOverview.aspx has Initialized.");
                tblInfo.Rows.Clear();
            ...
            //End
                log.DetailLog("AppOverview.aspx", "btnSearch_Click", STATE.COMPLETED, "Method: btnSearch_Click Inn Class: AppOverview.aspx Has Completed Its Execution Successfully.");
                    }
            catch(Exception ex) {
                Debug.WriteLine("Exception: " + ex.Message);
