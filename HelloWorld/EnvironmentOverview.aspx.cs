...
{
    public partial class EnvironmentOverview : System.Web.UI.Page
    {
        //Initializing Database Class Object
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                foreach (var item in latestPatchOfClient)
                {
                    ...
                    //System.Web.UI.HtmlControls.HtmlGenericControl Div_DataSource_Element_Text = new System.Web.UI.HtmlControls.HtmlGenericControl("div");
                    ...
                    //Div_DataSource_Element_Text.InnerText = "There is no data source for this application exist.";
                    //Div_DataSource.Controls.Add(Div_DataSource_Element_Text);
                    //}
