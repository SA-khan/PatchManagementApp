...
namespace HelloWorld.App_Code
{
    public class DataSource_Database
    {
        ...
        public string DB_SERVER_OS { get; set; }
        public string DB_SERVER_OS_BUILD { get; set; }
        public string DB_SERVER_REGISTER_TYPE { get; set; }
        public string DB_SERVER_VIRTUALIZATION { get; set; }
        public string DB_SERVER_PROCESSOR { get; set; }
        public string DB_SERVER_MEMORY { get; set; }
        public string DB_DIRECTORY_LOCATION { get; set; }
        public string DB_MDF_FILE_LOCATION { get; set; }
