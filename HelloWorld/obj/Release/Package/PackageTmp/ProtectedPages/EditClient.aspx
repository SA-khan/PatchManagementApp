<%@ Page Title="Portal - Edit Client" Language="C#" MasterPageFile="~/SiteLogout.Master" AutoEventWireup="true" CodeBehind="EditClient.aspx.cs" Inherits="HelloWorld.ProtectedPages.EditCompanyInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Edit Client">
