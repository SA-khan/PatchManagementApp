<%@ Page Title="Portal - Add Environemt Type" Language="C#" MasterPageFile="~/MasterPages/SimpleLogin.Master" AutoEventWireup="true" CodeBehind="AddEnvironmentType.aspx.cs" Inherits="HelloWorld.ProtectedPages.AddEnvironmentType" %>
